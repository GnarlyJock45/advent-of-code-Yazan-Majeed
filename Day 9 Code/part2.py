def main():
    ...
    # The file contains the coordinates of the red tiles in order
    vertices = []
    ...
    # Helper Function: To check if a point is strictly inside the green area
...
# The below code represents my first try in this problem, unfortunately the algorithm is wrong
# def main():
#     sum_dict = {}
#     counter = 0
#     coordinates_dict = {}
